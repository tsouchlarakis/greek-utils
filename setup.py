...
setup(
    ...
    entry_points={
        'console_scripts': [
            'greek-verbs=greek_verbs.cli:main',
        ],
    },
    ...
    keywords='greek_verbs',
    name='greek_verbs',
    packages=find_packages(include=['greek_verbs', 'greek_verbs.*']),
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/tsouchlarakis/greek-verbs',
    version='0.1.0',
    zip_safe=False,
)
